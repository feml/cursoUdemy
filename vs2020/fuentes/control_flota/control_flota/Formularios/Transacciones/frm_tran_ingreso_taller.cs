...
{
    public partial class frm_tran_ingreso_taller : Form
    {
        Interfaces.I_tran_registrar_ingreso _negocio;
        private string _cedula;
        private string _vehiculo;
        private string _trailer;
        private DataSet _ds;

        public frm_tran_ingreso_taller(string usuario, string password, string cadena)
        {
            InitializeComponent();
            lblUsuarioConectado.Text = usuario;
            _negocio = new Clases.C_tran_registrar_ingreso(usuario, password, cadena);
            _ds = new DataSet();

        }

        private void frm_tran_ingreso_taller_Load(object sender, EventArgs e)
        {
            _vehiculo = "ZZZZZZ";
            _trailer = "ZZZZZZ";
