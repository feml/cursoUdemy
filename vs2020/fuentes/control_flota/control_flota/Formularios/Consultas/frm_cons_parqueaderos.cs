...
{
    public partial class frm_cons_parqueaderos : Form
    {
        private Control_flota.Interfaces.I_cont_control_flota _negocio;
        private DataSet _ds;

        public frm_cons_parqueaderos(string usuario, string password, string cadena)
        {
            InitializeComponent();
        ...
        private void frm_cons_parqueaderos_Load(object sender, EventArgs e)
        {
            cargar_consulta();
        }
