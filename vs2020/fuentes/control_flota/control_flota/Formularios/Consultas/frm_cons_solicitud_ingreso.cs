...
{
    public partial class frm_cons_solicitud_ingreso : Form
    {
        private Control_flota.Interfaces.I_cont_control_flota _negocio;
        private DataSet _ds;

        public frm_cons_solicitud_ingreso(string usuario, string password, string cadena)
        {
            InitializeComponent();
        ...
        private void frm_cons_solicitud_ingreso_Load(object sender, EventArgs e)
        {
            cargar_consulta();
        }
        private void cargar_consulta()
        {
            _ds = _negocio.consulta_vehiculos_solicitados_taller();
