...
{
    public partial class frm_cons_anulacion_oficinas : Form
    {
        private Control_flota.Interfaces.I_cont_control_flota _negocio;
        private DataSet _ds;

        public frm_cons_anulacion_oficinas(string usuario, string password, string cadena)
        {
            InitializeComponent();
        ...
        private void frm_cons_anulacion_oficinas_Load(object sender, EventArgs e)
        {
            cargar_consulta();
        }
