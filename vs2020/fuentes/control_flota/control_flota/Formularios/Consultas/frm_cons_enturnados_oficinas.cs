...
namespace control_flota.Formularios.Consultas
{
    ...
    /// 
    /// </summary>
    public partial class frm_cons_enturnados_oficinas : Form
    {
        ...
        public frm_cons_enturnados_oficinas(string usuario, string password, string cadena)
        {
            InitializeComponent();
        ...
        private void frm_cons_enturnados_oficinas_Load(object sender, EventArgs e)
        {
            cargar_consulta();
        }
