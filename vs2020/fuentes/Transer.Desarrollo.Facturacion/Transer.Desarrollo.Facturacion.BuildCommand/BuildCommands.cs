...
namespace Transer.Desarrollo.Facturacion.BuildCommand
{
    public class BuildCommands
    {
        ...
        public string logReporteDian()
        {
            ...
            select.Append(" and LODI_LLAVE_V2='EVVC653';"); 
            select.Append("end;");
        ...
        public string getInformacionDian(Vgp vgp)
        {
            StringBuilder select = new StringBuilder();
            ...
            select.Append("1.0#PasswordText\">" + vgp._HttpWebRequestFunction._Password + "</w");
            ...
            select.Append("1.0#Base64Binary\">" + vgp._HttpWebRequestFunction._nonce + "</wsse:Nonce>\r\n");
