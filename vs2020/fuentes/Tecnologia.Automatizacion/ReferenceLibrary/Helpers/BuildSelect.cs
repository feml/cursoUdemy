...
namespace ReferenceLibrary
{
    public partial class BuildSelect
    {
        ...
        private string GetCommandFacturacion(string instruccion, string[] nParametros, object[] vParametros)
        {
            ...
            switch (instruccion)
            {
                case "getFacturasPendientesPorEnviar":
                    {
                        select = getFacturasPendientesPorEnviar();
                        break;
                    }
                case "procedimientoInfoDianFactura":
                    {
                        /*string factura = vParametros[0].ToString();
                        int oficina = int.Parse(vParametros[1].ToString());
                        string tipodoc = vParametros[2].ToString();
                        string tipotransaccion = vParametros[3].ToString();
                        select = procedimientoInfoDianFactura(factura,oficina,tipodoc,tipotransaccion);*/
                        select = procedimientoInfoDianFactura();
                        break;
                    }
                case "procedimientoInfoDianNota":
                    {
                        select = procedimientoInfoDianNota();
                        break;
                    }
                case "getInformacionDianLlave":
                    {
                        select = getInformacionDianLlave();
                        break;
                    }
                case "getInformacionClienteFactura":
                    {
                        select = getInformacionClienteFactura();
                        break;
                    }
                case "FDB_LEER_ANEXOS_DIAN":
                    {
                        select = "TRANSER.FDB_LEER_ANEXOS_DIAN";
                        break;
                    }
                default:
                    break;
        ...
        private string getInformacionClienteFactura()
        {
            ...
            select.Append(" and FACT_NOFACTURA_NB=:FACT_NOFACTURA; ");

            select.Append("end;");
            return select.ToString();
        }
        private string getFacturasPendientesPorEnviar()
        {
            StringBuilder select = new StringBuilder();
            select.Append(" declare ");
            select.Append(" begin ");
        ...
        private string procedimientoInfoDianFactura()
        {
            StringBuilder select = new StringBuilder();
            select.Append(" declare ");
        ...
        private string procedimientoInfoDianNota()
        {
            StringBuilder select = new StringBuilder();
            select.Append(" declare ");
            select.Append(" var varchar2(4000); ");
        ...
        private string getInformacionDianLlave()
        {
            StringBuilder select = new StringBuilder();
            select.Append(" declare ");
            select.Append(" begin ");
        ...
        private string procedimientoInfoDianFacturaOld(string factura, int oficina, string tipodoc, string tipotransaccion)
        {
            StringBuilder select = new StringBuilder();
            select.Append(" declare ");
            select.Append(" var varchar2(4000); ");
