...
{
    public partial class GenerarXml
    {
        ...
        public string procesar_manifiesto_carga(DataRow drw, string path, int oficina)
        {
            ...
            try
            {
                ...
                if (oficina == 39)
                {
                    string numManifiestoCarga = drw["numManifiestoCarga"].ToString();
                    string perro = numManifiestoCarga.Substring(2);
                    nodoVariables.Add(new XElement("numManifiestoCarga", perro));
                }
                else
                {
                    nodoVariables.Add(new XElement("numManifiestoCarga", drw["numManifiestoCarga"].ToString()));
        ...
        public string procesar_vehiculos(DataRow drw, string path, int oficina)
        {
            ...
            try
            {
                string ConfiguracionUC = drw["ConfiguracionUC"].ToString();
                if (ConfiguracionUC == "2")
                    nodoVariables.Add(new XElement("codConfiguracionUnidadCarga", drw["RIGIDOMIN"].ToString()));
                else
            ...
            try
            {
                string anoreportencia = drw["anoRepotenciacion"].ToString();
                if (anoreportencia.Length > 0)
